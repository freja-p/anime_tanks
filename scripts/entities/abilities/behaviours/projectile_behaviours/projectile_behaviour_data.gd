...
const PROJECTILE_BODY = preload("res://scenes/entities/components/abilities/autogun/autogun_projectiles/projectile_body/projectile_body.tscn")
const PROJECTILE_BEHAVIOUR_RAYCAST = preload("res://scenes/entities/components/abilities/autogun/autogun_projectiles/projectile_raycast/projectile_behaviour_raycast.tscn")
const PROJECTILE_MICROROCKET = preload("res://scenes/entities/components/abilities/micro_rockets/projectile_microrocket.tscn")
