...
func init_suspension(rest_force: float, arg_wheel_radius:float, arg_spring_distance_max_in: float, arg_spring_distance_max_out: float, arg_spring_constant: float, arg_spring_damping: float):
	wheel_radius = arg_wheel_radius
